      ...
      <div className='mt-4'>
        <div className="max-w-2xl m-4 p-4 rounded mx-auto mt-4">
          ...
          <div className='flex items-center mt-4'>
            <p className='font-normal text-base text-gray-00 mr-4'>Category</p>        
            <select className='form-select appearance-none w-2/5 block px-3 py-1 border border-solid border-gray-300 text-gray-700 text-base font-normal
              focus:outline-none focus:border-blue-600' onChange={handleCategory}>
